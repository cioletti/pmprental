/**
 * RetornoInterfacePosicaoExterna.java
 *
...
public class RetornoInterfacePosicaoExterna  implements java.io.Serializable {
    private java.lang.Integer codigoRetorno;

    private br.com.framew2.webservices.xsd.PosicaoEvento[] eventos;

    private java.lang.String mensagemRetorno;

    public RetornoInterfacePosicaoExterna() {
    }

    public RetornoInterfacePosicaoExterna(
           java.lang.Integer codigoRetorno,
           br.com.framew2.webservices.xsd.PosicaoEvento[] eventos,
    ...
    /**
     * Gets the codigoRetorno value for this RetornoInterfacePosicaoExterna.
     * 
    ...
    /**
     * Sets the codigoRetorno value for this RetornoInterfacePosicaoExterna.
     * 
     * @param codigoRetorno
     */
    ...
    /**
     * Gets the eventos value for this RetornoInterfacePosicaoExterna.
     * 
     * @return eventos
     */
    public br.com.framew2.webservices.xsd.PosicaoEvento[] getEventos() {
        return eventos;
    }


    /**
     * Sets the eventos value for this RetornoInterfacePosicaoExterna.
     * 
     * @param eventos
     */
    public void setEventos(br.com.framew2.webservices.xsd.PosicaoEvento[] eventos) {
        this.eventos = eventos;
    }

    public br.com.framew2.webservices.xsd.PosicaoEvento getEventos(int i) {
        return this.eventos[i];
    }

    public void setEventos(int i, br.com.framew2.webservices.xsd.PosicaoEvento _value) {
        this.eventos[i] = _value;
    }


    /**
     * Gets the mensagemRetorno value for this RetornoInterfacePosicaoExterna.
     * 
    ...
    /**
     * Sets the mensagemRetorno value for this RetornoInterfacePosicaoExterna.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof RetornoInterfacePosicaoExterna)) return false;
        RetornoInterfacePosicaoExterna other = (RetornoInterfacePosicaoExterna) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(RetornoInterfacePosicaoExterna.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://webservices.framew2.com.br/xsd", "RetornoInterfacePosicaoExterna"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://webservices.framew2.com.br/xsd", "PosicaoEvento"));
        elemField.setMinOccurs(0);
