package bean
{
	[RemoteClass(alias="com.pmprental.bean.OsEstimada")]
	public class OsEstimada
	{
		...
		private var _filialStore:String;
		...
		public function get filialStore():String
		{
			return _filialStore;
		}

		public function set filialStore(value:String):void
		{
			_filialStore = value;
		}
