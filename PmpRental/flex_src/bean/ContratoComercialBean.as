package bean
{
	...
	[RemoteClass(alias="com.pmprental.bean.ContratoComercialBean")]
	public class ContratoComercialBean
	{
		...
		private var _idFilialDestino:Number;
		...
		public function get idFilialDestino():Number
		{
			return _idFilialDestino;
		}

		public function set idFilialDestino(value:Number):void
		{
			_idFilialDestino = value;
		}
