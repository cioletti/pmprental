package bean
{
	[RemoteClass(alias="com.pmprental.bean.InspecaoPmpBean")]
	public class InspecaoPmpBean
	{
		...
		private var _horasRevisao:String;
		...
		public function get horasRevisao():String
		{
			return _horasRevisao;
		}

		public function set horasRevisao(value:String):void
		{
			_horasRevisao = value;
		}
