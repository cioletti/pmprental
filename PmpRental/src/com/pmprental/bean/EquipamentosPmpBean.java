...
public class EquipamentosPmpBean {
	...
	private BigDecimal HORAS_PENDENTES;
	private BigDecimal HORAS_MANUTENCAO;
	...
	public BigDecimal getHORAS_PENDENTES() {
		return HORAS_PENDENTES;
	}
	public void setHORAS_PENDENTES(BigDecimal hORAS_PENDENTES) {
		HORAS_PENDENTES = hORAS_PENDENTES;
	}
	public BigDecimal getHORAS_MANUTENCAO() {
		return HORAS_MANUTENCAO;
	}
	public void setHORAS_MANUTENCAO(BigDecimal hORAS_MANUTENCAO) {
